...
install_isrs:
    IDT_SET_GATE 0, _isr0, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 1, _isr1, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 2, _isr2, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 3, _isr3, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 4, _isr4, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 5, _isr5, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 6, _isr6, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 7, _isr7, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 8, _isr8, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 9, _isr9, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 10, _isr10, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 11, _isr11, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 12, _isr12, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 13, _isr13, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 14, _isr14, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 15, _isr15, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 16, _isr16, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 17, _isr17, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 18, _isr18, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 19, _isr19, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 20, _isr20, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 21, _isr21, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 22, _isr22, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 23, _isr23, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 24, _isr24, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 25, _isr25, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 26, _isr26, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 27, _isr27, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 28, _isr28, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 29, _isr29, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 30, _isr30, LONG_SELECTOR, 0x8E
    IDT_SET_GATE 31, _isr31, LONG_SELECTOR, 0x8E
